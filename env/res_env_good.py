...
class ResistanceGoodEnv:
    def __init__(self):
        super(ResistanceGoodEnv).__init__()
        """
        PHASES:
            (0) Team Building
            (1) Team Voting
    ...
    def step(self, action_dict, verbose=False):
        ...
        rewards_array = np.reshape(self._convert_dict_2d_array(rewards), (self.num_good, 1)  )
